...
var signUp = function signUp(data) {
  // this takes in the data that is returned from the event object and formatted by the getFormFields function in the events file
  return $.ajax({
...
var update = function update(round, data) {
  return $.ajax({
...
var destroy = function destroy(round) {
  return $.ajax({
    url: config.apiOrigin + '/rounds/' + round,
    method: 'DELETE',
    headers: {
...
var config = {
  apiOrigins: {
    ...
    production: 'https://archery-log-api.herokuapp.com'
  }
};
...
var store = __webpack_require__(4);
var showRoundsTemplate = __webpack_require__(17);
var api = __webpack_require__(3);
var getFormFields = __webpack_require__(5);

var signUpSuccess = function signUpSuccess(data) {
  // this is the object that is created from the ajax request
  $('#sign-up').hide();
...
var signUpFailure = function signUpFailure() {
  // this error also comes back from the ajax request
  $('#signUpFailMessage').show();
};

var signInSuccess = function signInSuccess(data, event) {
  ...
  $('.title').show();
  $('#newRoundButton').show();
  api.index().then(getRoundsSuccess).catch(getRoundsFailure);
};
...
var round = ''; // id used for editing round, coming from Handlebars
var deleteRoundID = ''; // id used for deleting round, coming from Handlebars
var getRoundsSuccess = function getRoundsSuccess(data) {
  $('#getRoundsFailMessage').hide();
  var showRoundsHtml = showRoundsTemplate({ rounds: data.rounds }); // this is putting the data object that contains all the rounds into a rounds object it can use when the method defined in HandleBars is invoked
  $('.all-rounds').html(showRoundsHtml);
  $('.editRoundButton').on('click', function () {
    // need to put this click handler here because the button needs to be loaded into the DOM before I can put a click handler on it (i.e. cannot put this event listener into memory on page load like the others)
    $('#editRoundModal').modal('show');
  });
  $('.editRoundButton').on('click', function (event) {
    // this shows the information in the edit modal of the round clicked
    event.preventDefault();
    round = $(this).data('id');
    api.show(round).then(onShowRoundSuccess).catch(onShowRoundFailure);
  });
  $('.editRoundButton').on('click', function () {
    $('#updateRoundFailMessage').hide();
  });
  $('#edit-round').on('submit', function (event) {
    // this allows you to edit the information in the modal and submit it
    var data = getFormFields(this);
    event.preventDefault();
    api.update(round, data).then(onUpdateRoundSuccess).catch(onUpdateRoundFailure);
  });
  ...
  $('#deleteConfirmButton').on('click', function (event) {
    event.preventDefault();
    api.destroy(deleteRoundID).then(onDeleteSuccess).catch(onDeleteFailure);
  });
  $('.deleteRoundButton').on('click', function () {
...
var getRoundsFailure = function getRoundsFailure(response) {
...
var onDeleteFailure = function onDeleteFailure(response) {
  $('#deleteRoundFailMessage').show();
};

var onShowRoundSuccess = function onShowRoundSuccess(round) {
...
var onShowRoundFailure = function onShowRoundFailure(response) {
...
var onUpdateRoundSuccess = function onUpdateRoundSuccess(event) {
  $('#updateRoundFailMessage').hide();
...
var onUpdateRoundFailure = function onUpdateRoundFailure(response) {
...
module.exports = {
  ...
  getRoundsSuccess: getRoundsSuccess,
  getRoundsFailure: getRoundsFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var setAPIOrigin = __webpack_require__(14);
var config = __webpack_require__(7);
...
var authEvents = __webpack_require__(16);
var roundEvents = __webpack_require__(35);
...
var parseNestedQuery = __webpack_require__(15);
...
var onSignUp = function onSignUp(event) {
  var data = getFormFields(this); // data: this is the result of the object that is created from the event handler and is formatted via the getFormFields function
  event.preventDefault();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"rounds-list\" class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-md-12\">\n        </div>\n        <div id=\"rounds-table\">\n            <table class=\"col-md-12 table-bordered table-striped table-condensed cf\">\n        <thead class=\"cf\">\n        <tr>\n          <th>Date</th>\n          <th>Range Name</th>\n          <th>Range Type</th>\n          <th>Bow Class</th>\n          <th>Arrows/End</th>\n          <th># of Ends</th>\n          <th>Total Score</th>\n          <th></th>\n        </tr>\n      </thead>\n      <tbody>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.rounds : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "        <tr>\n          <td data-title=\"Date\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "</td>\n          <td data-title=\"Range Name\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.range_name : stack1), depth0))
    + "</td>\n          <td data-title=\"Range Type\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.range_type : stack1), depth0))
    + "</td>\n          <td data-title=\"Bow Class\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.bow_class : stack1), depth0))
    + "</td>\n          <td data-title=\"Arrows/End\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.arrows_per_end : stack1), depth0))
    + "</td>\n          <td data-title=\"# of Ends\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.number_of_ends : stack1), depth0))
    + "</td>\n          <td data-title=\"Total Score\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total_score : stack1), depth0))
    + "</td>\n          <td><button class=\"editRoundButton\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button>\n          <button class=\"deleteRoundButton\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button></td>\n        </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "      <p class=\"noRoundsMessage\">No rounds currently logged. Click \"Log new round\" button above to begin!</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.rounds : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n</tbody>\n</table>\n</div>\n";
...
var onAddRound = function onAddRound(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.create(data, event).then(ui.addRoundSuccess).catch(ui.addRoundFailure);
};

var addHandlers = function addHandlers() {
  $('#addNewRoundModal').on('hidden.bs.modal', function (event) {
...
var addRoundSuccess = function addRoundSuccess(data, event) {
  store.round = data.round;
  $('#addNewRoundModal').modal('hide');
  $('.all-rounds').html(''); // this hides all rounds
  api.index(event).then(authUI.getRoundsSuccess).catch(authUI.getRoundsFailure);
};

var addRoundFailure = function addRoundFailure(response) {
  $('#addNewRoundFailMessage').show();
};

module.exports = {
  addRoundSuccess: addRoundSuccess,
  addRoundFailure: addRoundFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
// module
exports.push([module.i, "body {\n  padding-top: 50px;\n  background-image: url(https://i.imgur.com/f9dGiB7.jpg);\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-attachment: fixed;\n  background-size: cover;\n  background-color: white;\n  height: 100vh;\n  width: 100vw;\n}\n\nbutton {\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 16px;\n  font-weight: bold;\n  text-transform: uppercase;\n}\n\n.signUpLink {\n  font-weight: bold;\n}\n\n.navbar {\n  display: none;\n}\n\n.failure {\n  color: red;\n}\n\n.success {\n  color: green;\n}\n\n#signInFailMessage {\n  display: none;\n}\n\n#signUpSuccessMessage {\n  display: none;\n}\n\n#signUpFailMessage {\n  display: none;\n}\n\n#signOutFailMessage {\n  display: none;\n}\n\n#changePassSuccessMessage {\n  display: none;\n}\n\n#changePassFailMessage {\n  display: none;\n}\n\n#startGameFailMessage {\n  display: none;\n}\n\n#updateGameFailMessage {\n  display: none;\n}\n\n#getGamesFailMessage {\n  display: none;\n}\n\n#newRoundButton, #getRoundsButton {\n  display: none;\n  background: yellow;\n  color: black;\n  font-weight: bold;\n}\n\n#addNewRoundFailMessage {\n  display: none;\n}\n\n#addNewRoundModal {\n  display: none;\n}\n\n.title {\n  display: none;\n  color: yellow;\n  font-weight: bold;\n}\n\n#pageContent {\n  text-align: center;\n}\n\n#sign-up {\n  display: none;\n}\n\n#getRoundsFailMessage {\n  display: none;\n}\n\n#updateRoundFailMessage {\n  display: none;\n}\n\n#deleteRoundFailMessage {\n  display: none;\n}\n\n#showRoundFailMessage {\n  display: none;\n}\n\n.rounds-list {\n  color: yellow;\n}\n\n.editRoundButton, .deleteRoundButton {\n  background-color: black;\n  margin: 2px;\n}\n\n@media only screen and (max-width: 800px) {\n\n/* Force table to not be like tables anymore */\n\t#rounds-table table,\n\t#rounds-table thead,\n\t#rounds-table tbody,\n\t#rounds-table th,\n\t#rounds-table td,\n\t#rounds-table tr {\n\t\tdisplay: block;\n\t}\n\n\t/* Hide table headers */\n\t#rounds-table thead tr {\n\t\tposition: absolute;\n\t\ttop: -9999px;\n\t\tleft: -9999px;\n\t}\n\n\t#rounds-table tr { border: 1px solid #ccc; }\n\n\t#rounds-table td {\n\t\t/* Behave  like a \"row\" */\n\t\tborder: none;\n\t\tborder-bottom: 1px solid #eee;\n\t\tposition: relative;\n\t\tpadding-left: 50%;\n\t\twhite-space: normal;\n\t\ttext-align:left;\n\t}\n\n\t#rounds-table td:before {\n\t\t/* Now like a table header */\n\t\tposition: absolute;\n\t\t/* Top/left values mimic padding */\n\t\ttop: 6px;\n\t\tleft: 6px;\n\t\twidth: 45%;\n\t\tpadding-right: 10px;\n\t\twhite-space: nowrap;\n\t\ttext-align:left;\n\t\tfont-weight: bold;\n\t}\n\n\t#rounds-table td:before { content: attr(data-title); }\n}\n\nth {\n  background-color: rgba(88,88,88,1);\n}\n\ntd {\n  background-color: rgba(160,160,160,.8);\n}\n\n.noRoundsMessage {\n  color: yellow;\n  background-color: grey;\n  padding: 5px;\n  border-radius: 10px;\n}\n", ""]);
